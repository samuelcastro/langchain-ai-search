...
def lookup(name: str) -> str:
    ...
    tools_for_agent = [
        Tool(
            name="Crawl Google 4 Twitter profile page",  # name of the tool
            func=get_profile_url_tavily,  # This is the function that will be used by the agent
            description="useful when you need to get the TWitter Page URL",  # description of the tool, this will help the agent to understand the tool
        )
    ]
...
if __name__ == "__main__":
    twitter_username = lookup(name="Samuel Silva")
